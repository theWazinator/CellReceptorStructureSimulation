...
for ratio in hexagon_ratio_list:
    ...
    for molarity_index in range(0, len(mole_list)):
        ...
        receptor_list, actual_percent_coverage = create_receptor_list_HEXAGON(grid_point_length, ratio)
...
current_df.to_csv(path_or_buf="HEXAGON_Current.csv")

variance_df = pd.DataFrame.from_dict(variance_dict)
variance_df.to_csv(path_or_buf="HEXAGON_Variance.csv")