...
for percent_coverage in percent_coverage_list:
    ...
    for molarity_index in range(0, len(mole_list)):
        ...
        receptor_list, actual_percent_coverage = create_receptor_list_GRID(grid_point_length, percent_coverage)
...
current_df.to_csv(path_or_buf="GRID_Current.csv")

variance_df = pd.DataFrame.from_dict(variance_dict)
variance_df.to_csv(path_or_buf="GRID_Variance.csv")